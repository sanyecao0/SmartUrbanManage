<template>
  <a-layout class="content">
    ...
    <a-layout>
      ...
      <a-card title="城市信息" style="width: 100%;">
          <a-descriptions title layout="vertical" bordered>
              <a-descriptions-item label="城市名称" :span="3">Node 09</a-descriptions-item>
              <a-descriptions-item label="道路面积">60189亩</a-descriptions-item>
              <a-descriptions-item label="绿化面积">22209亩</a-descriptions-item>
              <a-descriptions-item label="建筑面积">35000亩</a-descriptions-item>
              <a-descriptions-item label="楼宇数量">12000栋</a-descriptions-item>
              <a-descriptions-item label="联系我们" :span="3">
                  <a-badge status="processing" text="+8616666666" />
              </a-descriptions-item>
          </a-descriptions>
      </a-card>
    <a-layout-footer style="margin: auto;">Copyright © 2024 智慧城管综合管理系统</a-layout-footer>
  </a-layout>
</template>
